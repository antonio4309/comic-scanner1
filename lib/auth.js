...
export const auth = betterAuth({
  ...
  // Dashboard / admin + analytics plugin (@better-auth/infra). dash() defaults
  // apiUrl to https://dash.better-auth.com and apiKey to BETTER_AUTH_API_KEY —
  // the /dash/* endpoints need that key set in Vercel to actually work.
  plugins: [
    dash(),
  ],
});
