      ...
      <div className="mx-auto max-w-3xl px-6 lg:max-w-5xl">
        ...
        <div className="mb-10 text-center">
          <p className="text-xs font-medium tracking-widest uppercase mb-3"
            style={{ fontFamily: "'Space Mono','Courier New',monospace", color: "#ff8e3e" }}>
            Everything You Need
          </p>
          <h2 className="text-3xl font-extrabold tracking-tight text-[#f8f6f2] md:text-5xl">
        ...
        <div className="relative z-10 grid grid-cols-6 gap-3">
            ...
            <CardContent className="relative m-auto size-fit pt-6">
              <div className="relative flex h-24 w-56 items-center">
                ...
                <svg
                  ...
                  style={{ color: "rgba(255,142,62,0.12)" }}
                ...
                <span className="mx-auto block w-fit text-5xl font-semibold text-[#ff8e3e]">9.8</span>
              </div>
              <h2 className="mt-6 text-center text-3xl font-semibold text-[#f8f6f2]">Instant Grading</h2>
              <p className="mt-2 text-center text-sm text-[#8c7b78]">AI condition estimate in under 3 seconds</p>
            </CardContent>
          </Card>

          {/* ── Card 2: CGC Slab Detection ───────────────────── */}
          <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
            <CardContent className="pt-6">
              <div className="relative mx-auto flex aspect-square size-32 rounded-full border border-white/10 before:absolute before:-inset-2 before:rounded-full before:border before:border-white/5">
                ...
                <svg className="m-auto h-fit w-24" viewBox="0 0 212 143" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    ...
                    fill="currentColor"
                  />
                  <g clipPath="url(#clip0_cgc_1)">
                    <path
                      d="M44.0209 55.3542C43.1945 54.7639 42.6916 54.0272 42.5121 53.1442C42.3327 52.2611 42.5995 51.345 43.3125 50.3958C50.632 40.3611 59.812 32.5694 70.8525 27.0208C81.8931 21.4722 93.668 18.6979 106.177 18.6979C118.691 18.6979 130.497 21.3849 141.594 26.7587C152.691 32.1326 161.958 39.8936 169.396 50.0417C170.222 51.1042 170.489 52.0486 170.196 52.875C169.904 53.7014 169.401 54.4097 168.688 55C167.979 55.5903 167.153 55.8571 166.208 55.8004C165.264 55.7437 164.438 55.2408 163.729 54.2917C157.236 45.0833 148.885 38.0307 138.675 33.1337C128.466 28.2368 117.633 25.786 106.177 25.7812C94.7257 25.7812 83.9827 28.2321 73.948 33.1337C63.9132 38.0354 55.5903 45.0881 48.9792 54.2917C48.2709 55.3542 47.4445 55.9444 46.5 56.0625C45.5556 56.1806 44.7292 55.9444 44.0209 55.3542Z"
                      fill="url(#paint0_cgc_1)"
                    />
                  </g>
                  <path d="M3 72H209" stroke="#ff8e3e" strokeWidth="6" strokeLinecap="round" />
                  <defs>
                    <linearGradient id="paint0_cgc_1" x1="106.385" y1="1.34375" x2="106" y2="72" gradientUnits="userSpaceOnUse">
                      <stop stopColor="white" stopOpacity="0" />
                      <stop offset="1" stopColor="#ff8e3e" />
                    </linearGradient>
                    <clipPath id="clip0_cgc_1">
              ...
              <div className="relative z-10 mt-6 space-y-2 text-center">
                <h2 className="text-lg font-semibold text-[#f8f6f2]">CGC Slab Detection</h2>
                <p className="text-sm text-[#8c7b78]">Reads slabbed comics automatically. Grade extracted from the label. No manual entry required.</p>
              </div>
            </CardContent>
          </Card>

          {/* ── Card 3: Live eBay UK Prices (waveform chart) ─── */}
          <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
            <CardContent className="pt-6">
              <div className="pt-6 lg:px-6">
                <svg className="w-full text-[#5c4542]" viewBox="0 0 386 123" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path
                    ...
                    stroke="#ff8e3e" strokeWidth="3"
                  />
                  <defs>
                    <linearGradient id="price_grad_fill" x1="3" y1="60" x2="3" y2="123" gradientUnits="userSpaceOnUse">
                      <stop stopColor="#ff8e3e" stopOpacity="0.25" />
                      <stop offset="1" stopColor="#ff8e3e" stopOpacity="0.02" />
                    </linearGradient>
                  </defs>
                </svg>
              </div>
              <div className="relative z-10 mt-8 space-y-2 text-center">
                <h2 className="text-lg font-semibold text-[#f8f6f2]">Live eBay UK Prices</h2>
                <p className="text-sm text-[#8c7b78]">Real sold-listing data, not estimates. Always current. Always the UK market.</p>
              </div>
            </CardContent>
          </Card>

          {/* ── Card 4: Whatnot CSV Export (area chart) ────────── */}
            ...
            <CardContent className="grid pt-6 sm:grid-cols-2">
              <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                <div className="relative flex aspect-square size-12 rounded-full border border-white/10 before:absolute before:-inset-2 before:rounded-full before:border before:border-white/5">
                  <Upload className="m-auto size-5 text-[#ff8e3e]" strokeWidth={1.5} />
                </div>
                <div className="space-y-2">
                  <h2 className="text-lg font-semibold text-[#f8f6f2]">Whatnot CSV Export</h2>
                  <p className="text-sm text-[#8c7b78]">One tap to a Whatnot-ready CSV. Title, condition, price — all pre-filled.</p>
                </div>
              </div>
              <div className="rounded-tl-2xl relative -mb-6 -mr-6 mt-6 h-fit border-l border-t border-white/8 p-6 sm:ml-6">
                ...
                <svg className="w-full sm:w-[150%]" viewBox="0 0 366 231" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path
                    ...
                    stroke="#ff8e3e" strokeWidth="2"
                  />
                  <defs>
                    <linearGradient id="export_fill" x1="0.85108" y1="0.947876" x2="0.85108" y2="230.114" gradientUnits="userSpaceOnUse">
                      <stop stopColor="#ff8e3e" stopOpacity="0.2" />
                      <stop offset="1" stopColor="#ff8e3e" stopOpacity="0.01" />
                    </linearGradient>
                  </defs>
                </svg>
              </div>
          ...
          {/* ── Card 5: Collection Dashboard ──────────────────── */}
          <Card className="relative col-span-full overflow-hidden lg:col-span-3">
            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
              <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                <div className="relative flex aspect-square size-12 rounded-full border border-white/10 before:absolute before:-inset-2 before:rounded-full before:border before:border-white/5">
                  <LayoutGrid className="m-auto size-5 text-[#ff8e3e]" strokeWidth={1.5} />
                </div>
                <div className="space-y-2">
                  <h2 className="text-lg font-semibold text-[#f8f6f2]">Collection Dashboard</h2>
                  <p className="text-sm text-[#8c7b78]">Every scan is logged with grade, value and condition. Your full collection at a glance.</p>
                </div>
              </div>
              ...
              <div className="before:bg-white/8 relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                <div className="relative flex h-full flex-col justify-center space-y-4 py-6">
                  {[
                    { label: "Total Value",  value: "£11,210", color: "#05df72" },
                    { label: "Top Grade",    value: "9.8 NM/MT", color: "#ff8e3e" },
                    { label: "Comics Scanned", value: "142",   color: "#f8f6f2" },
                    { label: "eBay Avg",     value: "£1,868",  color: "#d4c5c1" },
                  ].map((stat) => (
                    <div key={stat.label}
                      className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-3">
                      <span className="text-xs text-[#5c4542]"
                        style={{ fontFamily: "'Space Mono','Courier New',monospace" }}>
                        {stat.label}
                      </span>
                      <div className="flex items-center justify-center h-8 px-3 rounded-lg border border-white/8 bg-[#1a1008]"
                        style={{ minWidth: "4rem" }}>
